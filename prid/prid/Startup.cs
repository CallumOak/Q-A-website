...
namespace prid
{
	public class Startup
	{
		...
		{
			// services.AddDbContext<PridContext>(opt => opt.UseSqlServer(
			// 	Configuration.GetConnectionString("prid-mssql"))
			// ); 
			services.AddDbContext<PridContext>(opt => opt.UseMySql(
      			Configuration.GetConnectionString("prid-mysql"))
    		);
